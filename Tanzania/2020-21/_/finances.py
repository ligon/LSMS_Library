...
finance[['Income from rental payments', 'Income from pensions', 'Income from other sources']] = finance[['Income from rental payments', 'Income from pensions', 'Income from other sources']].replace('none', 0)
