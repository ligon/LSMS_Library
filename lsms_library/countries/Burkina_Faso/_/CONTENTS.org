...
=_decode_mojibake= hook *nor* a =_LOST_PREFIX_REPLACEMENTS= dict.
...
not have that hook.*  Whichever way this is unified, the read and the
crosswalk must move in the same commit.
