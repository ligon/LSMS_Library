...
|-------+---------+-----------------------------------------+---------------------------|
| 9,635 | 2014    | =Cube (Maggi, Jumbo,<0085>)=            | =...= cp1252 ellipsis 0x85 |
| 1,901 | 2014    | =Viandes de b<009C>ufs fraîches=        | =oe= ligature, cp1252 0x9C |
| 1,397 | 2018-19 | =Viande de b<00C5><0093>uf=             | =oe= ligature, double-encoded |

Two *distinct* failures are mixed here: 0x85 and 0x9C are *cp1252* bytes read
as latin-1 (the C1-control signature), while =<00C5><0093>= is the familiar
double-encoding.  A single =.encode('latin-1').decode('utf-8')= repairs the
third and *not* the first two, which need a cp1252 decode -- so the existing
=_decode_mojibake= helper is necessary but not sufficient for this country.
...
same mojibake.  Three of the EHCVM countries (CotedIvoire, Guinea-Bissau,
