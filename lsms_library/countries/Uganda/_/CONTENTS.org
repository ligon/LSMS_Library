...
The cause is *not established* -- it could be UBOS recording the value in
hundreds of shillings for this wave, or a data-preparation error -- so *no
correction factor is applied here*.  Inventing a x100 would be a guess
wearing a decimal point.  What is recorded is the measurement.
