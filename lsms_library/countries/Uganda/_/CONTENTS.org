...
- *The defect is field-specific.*  Scanning every numeric variable present in
  both waves across 16 AGSEC files, *=a5aq8= and =a5bq8= are the ONLY two
  whose median moves by ~100x* (93.6x and 100.0x) and the only two whose
  Stata type changes int32 -> double.  =a5aq10= ("How much was spent on
