...
unit conversion factor file from previous ESS waves." GH #TBD
...
EPAR's do-file resolves it by keeping 4.34 and dropping 6.125
(=EPAR_UW_Ethiopia_ESS_W5.do:349=): "W5 raw data file Crop_CF_Wave5.dta
has duplicate observations for crop_code=74, unit_cd=62. Based on W3
data, we have chosen to retain cf=4.34 (and drop cf=6.125) for
continuity."
