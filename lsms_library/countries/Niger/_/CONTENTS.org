...
are two-job sums of individually-plausible schedules, not sentinels, and are
left alone.
...
168 h/week and 50 exceed 112 (2014-15: 0 and 10).  These are not declared
missing codes -- they are sums over two jobs each of whose reported schedule is
individually possible.  A plausibility screen on reported schedules is a
separate decision.
