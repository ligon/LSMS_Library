...
- STALE, was "No =categorical_mapping.org=" :: *This bullet was already
  false when GH #783 read it; quoted rather than deleted so the correction
  is on the record.*  =_/categorical_mapping.org= exists
  (=harmonize_education=, =Roof=, =Floor=) and, since GH #783, also
  carries =harmonize_food=.
- STALE, was "No =food_items.org=" :: *Superseded twice.*  The file was
  created 2026-06-08 (see "DONE food_items.org" above -- the "Known
