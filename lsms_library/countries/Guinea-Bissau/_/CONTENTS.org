...
|------+--------------------------------+---------------------------------+-----------------------------------------|
| 2018-19 | 104,493 -> 103,471 | 91,353,380 -> 59,225,643 (-35.2%) | 6,486 / 3,985 / 18 |
...
reshape and the (t, v, i, j, u, s) collapse).
  ...
  Validated against =ehcvm_conso_gnb2018.dta=: on the 35 rows where the
  join and the unit match both hold and the candidates differ,
  =(s07bq03a - s07bq04 - s07bq05) * uv * 365/7= reproduces =depan(Achat)=
  within 1% for *100%* of rows, against 48.6% for the residual served here
  and 0.0% for the gross quantity.
