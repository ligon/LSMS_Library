...
2. *The metric rows were not per-unit prices.*  Where the size field
   ...
   *The fix* (=nigeria.community_prices_for_wave=, registered as
   ...
   UNRECORDED -- all of W3's 13,768 g/cl rows bar one (c8q2b blank), and
   W4's 1,191 'Grams(g)' rows (c8q2c blank) -- is DROPPED: its price is of
   an unrecorded package and cannot be normalised.  The '99. ONE SIZE
