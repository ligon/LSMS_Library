...
— across the 190,618 → 189,236 row reduction.  (That Expenditure total is
the PRE-#876 one, i.e. the raw =s07bq08= sum; since 2026-09-12 the served
purchased total is 73,221,529.68 — see "one row, two windows" below.  The
conservation property this section is about is unchanged.)
...
** household_roster 2018-19: =Frere, soeur= read with a C1 control byte (GH #801)
...
served =Frere, s<U+009C>ur= (895 rows).  pyreadstat's default, or
...
the file's own casing (Benin runs no =Relationship= formatter), as CotedIvoire / Burkina Faso 2018-19 serve it; kinship tuple [0, 1, consanguineal] unchanged; 895 rows changed,
...
Same defect and same fix in Niger 2018-19, Senegal 2018-19 and Togo 2018 (all format-115 cp1252 EHCVM-1
...
column:
  ...
  : Benin::food_acquired::7day-purchase-at-last-purchase-unit-value

Raw answers come back by their original names from
=Country('Benin').derivation_inputs(key, wave=...)=.
...
|------+---+---+---+---|
| 2018-19 | 167,087 -> 147,149 | 87,287,927 -> 68,929,997 (-21.0%) | 0 -> 18,632 (53,318) | 14,334 (9.7%): 6,451 / 4,143 / 3,740 |
...
- 2018-19: A (gross =s07bq03a=) 75,023,618, B (net of own production) 73,221,530, *C (served)* 68,929,997 FCFA; raw =s07bq08= was 87,287,927.
