...
| Condiment                    | Condiment                    |     103 | other condiments (royco,maggie,etc)                         |         |                            |
...
| Tea                          | Tea                          |     131 | tea                                                         |         |                            |
| Other Beverages              | Other Beverages              |     132 | other beverage drinks                                       |      92 | non-alchoholic beverages   |
...
| Other Alcoholic Beverages    | Other Alcoholic Beverages    |         |                                                             |      91 | alchoholic beverages       |
...
* Education (GLSS5 Section 2A, s2aq2) -- GH #171 / #731
...
# every label parta/sec2a.dta:s2aq2 emits.  All 32 labels the file carries
...
# check.
#
# Why a wave table: `u6` here is UPPER SIXTH.  The GLSS5 questionnaire
# (G5QPartA.pdf p.11, Section 2A Q2 "What was the highest grade completed?")
# codes  S5=31, L6=32, U6=33, Voc/Technical=41, Teacher Train=42, Nursing=43,
# Polytechnic=51, University=52, Other Tertiary=53  -- university is its own
# rung, so u6 is the end of secondary school.  In GLSS1/2/3 the same letters
# U1..U8 are YEARS OF UNIVERSITY, which is what the country table now says;
# the two readings cannot share one table.  The rows below are byte-for-byte
# the values the country table gave this wave before 2026-09-02 (verified:
# api_before_731.out == api_after_731.out for 2005-06).
