...
|---------+-------------------------------------+----------------------------------------------------+----------------+-------------------+-------------------|
| 1987-88 | =Data/PRICE.DAT= (+ =PRICE.DCT=)      | LOCALITY / CLUSTER (1987 form, rendered)           |            165 | 165/165           | 165/176           |
| 1988-89 | =Data/PRICE.DAT=                      | same form (the 1988 PDF is the same blob as 1987's) |            112 | 112/112           | 112/170           |
...
176 first year clusters") is the 165 distinct =CLUST= in the file.  Two
1998-99 price clusters (of 253) are not in =SEC0A.DTA=.
...
(interview month, then description/brand, then slot):
