...
# cluster_features is declared at (t, v) but s00_me_sen2018.dta is the HOUSEHOLD
# cover file -- 7,156 household rows for 598 grappes.  This df_edit hook reduces
# the extraction to true cluster grain and ENFORCES that Region / Rural /
# Latitude / Longitude are single-valued within a grappe (they are: 0 of 598
