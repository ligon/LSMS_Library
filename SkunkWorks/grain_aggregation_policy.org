...
most complete row (fewest NA cells over the columns core does NOT reduce; ties on
original order), narrowed to =levels= and key-sorted so shape and row order do
not move.  This REVERSES the 2026-07-13 "complementary missingness is COMPLETION"
