...
#                 month='saq13m',
#                 day='saq13d')
# df = df_data_grabber('../Data/secta_harvestw1.csv',idxvars,**myvars)
# df['date'] = pd.to_datetime(df[['year', 'month', 'day']], errors='coerce')
# df=df.drop(columns=['year','month','day'])
##Planting(2010Q3)
# idxvars = dict(j='hhid',
...
#                 month='saq13m',
#                 day='saq13d')
# df_1 = df_data_grabber('../Data/secta_plantingw1.csv',idxvars,**myvars)
# df_1['date'] = pd.to_datetime(df_1[['year', 'month', 'day']], errors='coerce')
# df_1=df_1.drop(columns=['year','month','day'])