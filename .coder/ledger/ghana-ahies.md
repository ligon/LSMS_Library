...
### Phase 3 (continued) -- 2022, 2023 and the three extra 2024 tables (three worktree agents, merged 2026-09-17)

- `2022/_/{sample,household_roster,individual_education,food_security,housing}.py` (branch `feat/ghanaahies-2022`, merge `a45fe175a`): rows per t exact against the README (sample 10,761 / 10,628 / 10,422 / 10,309; roster 52,914 / 53,617 / 53,130 / 50,282). OK (anchored on §4, §5). CONTRADICTION of §4's "s1aq2x is the corrected code": in 2022 `s1aq2x` is one of 319 all-null columns, so the raw `s1aq2` (clean there: 0 double-headed, 0 code 17) is read, with an assert that fails loudly if a re-release fills it. CONTRADICTION of §4's "16 `s1*` columns": they are `s10q*`/`s10bq*`/`s11bq*` (Section 10/11B), 2022Q1-Q3 only -- corrected in §4 and the README.
